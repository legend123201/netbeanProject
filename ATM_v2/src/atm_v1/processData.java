...
//        Customer cs=new Customer("Toi La Toi", "711A20072180", "abc120", 9999);
//        list.add(cs);
//        writeListToFile(list, f);
//        System.out.println(list.size());
//        try {
//            for(int i=0;i<list.size();i++){
//                String line1 = list.get(i).name + " " + list.get(i).so_tk + " " + list.get(i).pass + " " + String.valueOf(list.get(i).tk);
